const translations = {
    vi: {
        ...
        'highlight.2.title': 'Voice cloning tức thì',
        ...
        'demo.voice1.name': 'Nam - Miền Bắc',
        'demo.voice2.name': 'Nữ - Miền Bắc',
        'demo.voice3.name': 'Nam - Miền Nam',
        ...
        'features.2': 'Hoàn toàn offline',
        'features.3': 'Hỗ trợ CPU/GPU, GGUF sắp ra mắt',
        ...
        'comparison.model1000': 'VieNeu-TTS-1000h',
        'comparison.dataset': 'Kích thước dataset',
        'comparison.pronunciation': 'Chất lượng phát âm',
        ...
        'pricing.raw': 'Dữ liệu audio thô',
        'pricing.under10h': 'Dưới 10h',
        'pricing.10to30h': '10–30h',
        'pricing.30to50h': '30–50h',
        'pricing.over50h': 'Trên 50h',
        'pricing.custom': 'Tùy chỉnh',
        'pricing.includes': 'Bao gồm',
        'pricing.includes.1': 'Giấy phép thương mại',
        'pricing.includes.2': 'File mô hình + hướng dẫn tích hợp',
        ...
        'tech.codec': 'Codec',
        'tech.context': 'Context',
        'tech.watermark': 'Watermark',
        'tech.enabled': 'Đã bật',
        ...
        'author.role': 'Người Sáng Tạo & Nhà Phát Triển',
        'author.bio': 'Nhà nghiên cứu và phát triển AI đam mê, chuyên tâm phát triển công nghệ Text-to-Speech tiếng Việt. Người sáng tạo VieNeu-TTS, mang giọng nói Việt Nam chân thật đến với thế giới.',
        'author.facebook': 'Facebook',
        'author.github': 'GitHub',
        'author.huggingface': 'Hugging Face',
    ...
    en: {
        ...
        'highlight.2.title': 'Instant voice cloning',
        ...
        'demo.voice1.name': 'Male - North',
        'demo.voice2.name': 'Female - North',
        'demo.voice3.name': 'Male - South',
        ...
        'features.2': 'Fully offline inference',
        'features.3': 'CPU/GPU support, GGUF coming soon',
        ...
        'comparison.model140': 'VieNeu-TTS-140h',
        'comparison.model1000': 'VieNeu-TTS-1000h',
        'comparison.dataset': 'Dataset size',
        'comparison.pronunciation': 'Pronunciation quality',
        ...
        'pricing.raw': 'Raw Audio Data',
        'pricing.under10h': 'Under 10h',
        'pricing.10to30h': '10–30h',
        'pricing.30to50h': '30–50h',
        'pricing.over50h': 'Over 50h',
        'pricing.custom': 'Custom Quote',
        'pricing.includes': 'Includes',
        'pricing.includes.1': 'Commercial license',
        'pricing.includes.2': 'Model file + integration guide',
        ...
        'author.name': 'Phạm Nguyễn Ngọc Bảo',
        'author.role': 'Creator & Developer',
        'author.bio': 'Passionate AI researcher and developer dedicated to advancing Vietnamese Text-to-Speech technology. Creator of VieNeu-TTS, bringing authentic Vietnamese voices to the world.',
        'author.facebook': 'Facebook',
        'author.github': 'GitHub',
        'author.huggingface': 'Hugging Face',
